...
<x:xmpmeta xmlns:x="adobe:ns:meta/" x:xmptk="Adobe XMP Core 7.0">
 <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about=""
   ...
   crs:IncrementalTemperature="${fmtSigned(v.incrementalTemp)}"
   crs:IncrementalTint="${fmtSigned(v.incrementalTint)}"
   ...
   crs:ParametricShadows="${fmtSigned(v.parametricShadows)}"
   crs:ParametricDarks="${fmtSigned(v.parametricDarks)}"
   crs:ParametricLights="${fmtSigned(v.parametricLights)}"
   crs:ParametricHighlights="${fmtSigned(v.parametricHighlights)}"
   crs:ParametricShadowSplit="${fmtUnsigned(v.parametricShadowSplit)}"
   crs:ParametricMidtoneSplit="${fmtUnsigned(v.parametricMidtoneSplit)}"
   crs:ParametricHighlightSplit="${fmtUnsigned(v.parametricHighlightSplit)}"
   ...
   crs:LuminanceNoiseReductionContrast="${fmtUnsigned(v.luminanceNoiseContrast)}"
...
${hslLines.join('\n')}
   ...
   crs:PostCropVignetteHighlightContrast="${fmtUnsigned(v.vignetteHighlightContrast)}"
   crs:ShadowTint="0"
   crs:RedHue="0"
   crs:RedSaturation="0"
   crs:GreenHue="0"
